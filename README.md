...
├── data/        # Contains sales data (CSV files)
├── prompts/     # Prompts used to analyze the data with AI
├── insights/    # AI-generated responses and insights
├── scripts/     # Python (pandas) scripts for reading and processing CSV data
└── README.md
```

## Sugestted Prompts

### 📌 1. Prompts for Data Interpretation — Sales Overview
